...
class DynamicDataWorkbench(Workbench):
    ...
    def Initialize(self):
        ...
        self.list = ["DynamicDataCreateObject", "DynamicDataAddProperty", "DynamicDataRemoveProperty", "DynamicDataSettings"] # A list of command names created in the line above
